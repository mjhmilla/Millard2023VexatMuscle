...
%Structurally distinct segments of titin
  ...
  ligpZero  = felineSoleusMuscle.curves.forceLengthIgpCurve.xEnd(1,1);
  lpevkZero = felineSoleusMuscle.curves.forceLengthPevkIgdCurve.xEnd(1,1);
  ...
  ligpFiso  = calcBezierYFcnXDerivative((1-lambdaECM),...
              felineSoleusMuscle.curves.('forceLengthIgpInverseCurve'),...
              0);
            
  lpevkFiso = calcBezierYFcnXDerivative((1-lambdaECM),...
              felineSoleusMuscle.curves.('forceLengthPevkIgdInverseCurve'),...
              0);
...
%     hold on;
  ...
  normLengthIgdFixedHuman = ...
    numanSoleusMuscle.sarcomere.IGDFixedNormLengthAtOptimalFiberLengthHuman; 

  normLengthIgdFixed = ...
    felineSoleusMuscle.sarcomere.IGDFixedNormLengthAtOptimalFiberLength; 

  normLengthIgdTotal = ...
    felineSoleusMuscle.sarcomere.IGDTotalNormLengthAtOptimalFiberLength;
...
if(felineSoleusMuscle.sarcomere.titinModelType==1)
    ...
    [ curveSampleECMHalfPD,...
      ...
      sampleTitinCurves(curveSampleFPE.x.*0.5,...
                        felineSoleusMuscle.curves.forceLengthECMHalfCurve,...
                        felineSoleusMuscle.curves.forceLengthLumpedIgCurve,...
                        felineSoleusMuscle.curves.forceLengthLumpedIgInverseCurve,...
                        felineSoleusMuscle.curves.forceLengthPEVKCurve,...
                        felineSoleusMuscle.curves.forceLengthPEVKInverseCurve,...
                        normLengthZToT12,...
                        normLengthProximalTitinAtOptimalFiberLength,...
                        normLengthDistalTitinAtOptimalFiberLength,...
                        normLengthIgdFixed,...
...
[ curveSampleECMHalf,...
  ...
  sampleTitinCurves(curveSampleFPE.x.*0.5,...
                    felineSoleusMuscle.curves.forceLengthECMHalfCurve,...
                    felineSoleusMuscle.curves.forceLengthIgpCurve,...
                    felineSoleusMuscle.curves.forceLengthIgpInverseCurve,...
                    felineSoleusMuscle.curves.forceLengthPevkIgdCurve,...
                    felineSoleusMuscle.curves.forceLengthPevkIgdInverseCurve,...
                    normLengthZToT12,...
                    normLengthIgpAtOptimalFiberLength,...
                    normLengthPevkAtOptimalFiberLength,...
...
[ curveSampleECMHalfHuman,...
  ...
  sampleTitinCurves(curveSampleFPE.x.*0.5,...
                    humanSoleusMuscle.curves.forceLengthECMHalfCurve,...
                    humanSoleusMuscle.curves.forceLengthIgpCurve,...
                    humanSoleusMuscle.curves.forceLengthIgpInverseCurve,...
                    humanSoleusMuscle.curves.forceLengthPevkCurve,...
                    humanSoleusMuscle.curves.forceLengthPevkInverseCurve,...
                    normLengthZToT12,...
                    normLengthIgpAtOptimalFiberLength,...
                    normLengthPevkAtOptimalFiberLength,...
                    normLengthIgdFixedHuman,...
...
[ curveSampleECMHalfHumanB,...
  ...
  sampleTitinCurves(curveSampleFPE.x.*0.5,...
                    humanSoleusMuscle.curves.forceLengthECMHalfCurve,...
                    humanSoleusMuscle.curves.forceLengthIgpCurveB,...
                    humanSoleusMuscle.curves.forceLengthIgpInverseCurveB,...
                    humanSoleusMuscle.curves.forceLengthPevkCurveB,...
                    humanSoleusMuscle.curves.forceLengthPevkInverseCurveB,...
                    normLengthZToT12,...
                    normLengthIgpAtOptimalFiberLength,...
                    normLengthPevkAtOptimalFiberLength,...
                    normLengthIgdTotal,...
