...
normLength31r0 = interp1(dataVexat.benchRecord.time(:,1),...
                         dataVexat.benchRecord.normFiberLength(:,1),tr0);

normLength31r1 = interp1(dataVexat.benchRecord.time(:,1),...
                         dataVexat.benchRecord.normFiberLength(:,1),tr1);
...
idxMap31 = [];
switch(size(dataVexat.benchRecord.time,2))
  case 1
    idxMap31=[1];
  case 2
    idxMap31=[1,2];    
...
for i=1:1:size(idxMap31,2)
  if(i==1)
    lineVexat = plot(dataVexat.benchRecord.time(:,idxMap31(1,i)), ...
                      dataVexat.benchRecord.tendonForce(:,idxMap31(1,i)),...
                      lineTypeModel,'Color',lineColorModel,'LineWidth',lineWidthModel,...
                      'DisplayName',nameModel);      
  else
    plot(dataVexat.benchRecord.time(:,idxMap31(1,i)), ...
                      dataVexat.benchRecord.tendonForce(:,idxMap31(1,i)),...
                      lineTypeModel,'Color',lineColorModel,'LineWidth',lineWidthModel,...
                      'DisplayName',nameModel);
  end
...
%for i=1:1:size(idxMap31,2)
  ...
  plot(dataVexat.benchRecord.time(:,idxMap31(1,i)), ...
      dataVexat.benchRecord.musculotendonStiffness(:,idxMap31(1,i))./1000,...
      lineTypeModel,'Color',lineColorModel,'LineWidth',lineWidthModel,...
      'DisplayName',nameModel);
  hold on;
%end
...
k31r1 = interp1(dataVexat.benchRecord.time(:,idxMap31(1,i)),...
              dataVexat.benchRecord.musculotendonStiffness(:,idxMap31(1,i)),...
              tr1)/1000;
...
[kMax31,idxKmax31] = max(dataVexat.benchRecord.musculotendonStiffness(:,idxMap31(1,i))./1000);
[kMin31,idxKmin31] = min(dataVexat.benchRecord.musculotendonStiffness(:,idxMap31(1,i))./1000);
...
i=1;
  ...
  plot(dataVexat.benchRecord.time(:,idxMap31(1,i)), ...
      dataVexat.benchRecord.musculotendonDamping(:,idxMap31(1,i))./1000,...
      lineTypeModel,'Color',lineColorModel,'LineWidth',lineWidthModel,...
      'DisplayName',nameModel);
  hold on;
%end
...
d310 = interp1(dataVexat.benchRecord.time(:,idxMap31(1,i)),...
              dataVexat.benchRecord.musculotendonDamping(:,idxMap31(1,i)),...
              t0)/1000;
d31r1 = interp1(dataVexat.benchRecord.time(:,idxMap31(1,i)),...
              dataVexat.benchRecord.musculotendonDamping(:,idxMap31(1,i)),...
              tr1)/1000;
...
if(trialNumber == 3 && flag_useElasticTendon==1)
  %legend([lineVexat,lineHill,lineExp],'Model', 'Hill-type',expLabel);
