...
%   end
  ...
  colorTitinActive  = csVib.red;
  colorTitinPassive = csVib.blue;
...
%                   '$$\ell^{T12}+\ell^{Igp}(f)+\ell^{PEVK}(f)+\ell^{Igd}$$'};  
  ...
  plotProps(idx).xlim   = ([0,0.46] + [-0.01,0.01]);  
...
%   end
  ...
  fill(fillx,filly,[csVib.blue],'EdgeColor','none','FaceAlpha',0.25,...
