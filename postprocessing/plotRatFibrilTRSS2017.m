...
xyErrRecord(3) = struct('x',zeros(1,1).*nan,...
                        'y',zeros(1,1).*nan,...
                        'err',zeros(1,1).*nan);
dxyErrRecord(3) = struct('x',zeros(1,1).*nan,...
                        'y',zeros(1,1).*nan,...
                        'err',zeros(1,1).*nan);
for i=1:1:3
  xyErrRecord(i).x=nan;
  xyErrRecord(i).y=nan;
  xyErrRecord(i).err=nan;
  dxyErrRecord(i).x=nan;
  dxyErrRecord(i).y=nan;
  dxyErrRecord(i).err=nan;  
end
xAtErrMax = nan; 
dxAtErrMax = nan; 
...
subplotPosition = reshape(plotConfig.subPlotPanel(1,1,:),1,4);
    ...
    plot(sampleFlNOrig.x,sampleFlNOrig.y,'-',...
         'Color',[1,1,1].*0.75,'DisplayName','$$f^L(\tilde{\ell}^M)$$');
    hold on;
    plot(sampleFlNFitted.x,sampleFlNFitted.y,'-',...
         'Color',[1,1,1].*0.75,'DisplayName','$$f^L(\tilde{\ell}^M) (fitted)$$');
    hold on;
...
subplotPosition = reshape(plotConfig.subPlotPanel(1,2,:),1,4);
    ...
    plot(sampleFlNFitted.x,sampleFlNFitted.y,'-',...
         'Color',[1,1,1].*0.75,'DisplayName','$$\tilde{f}^L(\tilde{\ell}^M)$$');
    hold on;        
    ...
    plot(sampleFlNFitted.x,...
         ...
         'Color',[1,1,1].*0.75,'DisplayName','$$f^L(\tilde{\ell}^M)f^V(0.11\,\tilde{v}^M_{max})$$');
    hold on;  
    plot(sampleFlNFitted.x,...
         sampleFlNFitted.y.*fvNFitted,'-',...
         'Color',[1,1,1].*0.75,'DisplayName','$$f^L(\tilde{\ell}^M)f^V(0.11\,\tilde{v}^M_{max})$$ (fitted)');
    hold on;  
    ...
    for idx=simConfig.trials
        ...
        plot(expTRSS2017Raw.(seriesName).lN,...
             ...
             'DisplayName','$$\tilde{f}^{EXP}$$ TRSS2017',...
...
subplotPosition = reshape(plotConfig.subPlotPanel(2,1,:),1,4);
  ...
  if(flag_plotAllTrials==1)
    ...
    plot(expTRSS2017Raw.(seriesName).time,...
         ...
         '-','Color',plotConfig.lineColors.exp(idx,:),...
         'LineWidth',lineWidthExp,...
         'DisplayName',['TRSS2017: $$\tilde{f}^{EXP}_',num2str(idx),'$$'],...
    ...
    text(expTRSS2017Raw.(seriesName).time(end),...
         ...
         sprintf('%s%i%s','$$\tilde{f}^{EXP}_{',idx,'}$$'),...
         'HorizontalAlignment','left',...
    ...
    text(expTRSS2017Raw.(seriesName).time(end),...
         ...
         sprintf('%s%i%s','$$\tilde{\sigma}^{EXP}_{',idx,'}$$'),...
         'HorizontalAlignment','left',...
         'VerticalAlignment','baseline',...
         'FontSize',8,...
         'Color',plotConfig.lineColors.exp(idx,:),...
...
text(xP,yP*fvN,'$$f^{L}(\tilde{\ell}^M)f^{V}(0.11\,\tilde{v}^M_{max})$$',...
    'HorizontalAlignment','right',...
          ...
          case 0
            ...
            text(pubPlotOptions.lceNMin+dx,pubPlotOptions.fceNMax,...
                 sprintf('%s',...
                   ...
                   'avg. force & std force\\',...
                   ' $$\tilde{f}_1^{EXP}$$ & $$\tilde{\sigma}_1^{EXP}$$ \\',...
                   ' $$\tilde{f}_2^{EXP}$$ & $$\tilde{\sigma}_1^{EXP}$$ \\',...
                   '$$\tilde{f}_3^{EXP}$$ & $$\tilde{\sigma}_1^{EXP}$$',...
                   ' \end{tabular}']),...
                 'HorizontalAlignment','left',...
                 'VerticalAlignment','top',...
                 'FontSize',8);
            ...
            text(pubPlotOptions.lceNMin+dx,pubPlotOptions.fceNMax,...
                 sprintf('%s\n%s',...
                   ...
                   ['\begin{tabular}{l l l l}',...
                    'Avg. fiber force & $$\tilde{f}_1^{EXP}$$ & $$\tilde{f}_2^{EXP}$$ & $$\tilde{f}_3^{EXP}$$\\',...
                    'Fiber force std. & $$\tilde{\sigma}_1^{EXP}$$ & $$\tilde{\sigma}_2^{EXP}$$ & $$\tilde{\sigma}_3^{EXP}$$\\',...
                    '\end{tabular}']),...
                 'HorizontalAlignment','left',...
                 'VerticalAlignment','top',...
                 'FontSize',8);
...
title({'B. Lengthening data and fitting points' ...
       'resolved in force-length space'},...
...
for idx=simConfig.trials     
    ...
    subplotPosition = reshape(plotConfig.subPlotPanel(3,1,:),1,4);
        ...
        plot(titinAnalysis(idx).lceN, ...
             ...
             'DisplayName',['$$\tilde{f}^C_',num2str(idx),'$$'],...
             'HandleVisibility',hVis);
        hold on;
        text(titinAnalysis(idx).lceN(end),...
             titinAnalysis(idx).f2N(end),...
             sprintf('%s%i%s','$$\tilde{f}^{C}_{',idx,'}$$'),...
             'HorizontalAlignment','right',...
             'VerticalAlignment','baseline',...
             'FontSize',8,...
             'Color',plotConfig.lineColors.calcTitinF(idx,:),...
            ...
            case 0
              ...
              text(pubPlotOptions.lceNMin+dx,pubPlotOptions.fceNMax,...
                   sprintf('%s',...
                     ...
                     ' $$\tilde{f}_1^{EXP}$$ & $$\tilde{f}_1^{C}$$ \\',...
                     ' $$\tilde{f}_2^{EXP}$$ & $$\tilde{f}_2^{C}$$ \\',...
                     '$$\tilde{f}_3^{EXP}$$ & $$\tilde{f}_3^{C}$$',...
                     ' \end{tabular}']),...
                   'HorizontalAlignment','left',...
                   'VerticalAlignment','top',...
                   'FontSize',8);
            ...
            case 1
              ...
              text(pubPlotOptions.lceNMin+dx,pubPlotOptions.fceNMax,...
                   sprintf('%s\n%s',...
                     'TRSS2017',...
                     ['\begin{tabular}{l l l l}',...
                      'fiber & $$\tilde{f}_1^{EXP}$$ & $$\tilde{f}_2^{EXP}$$ & $$\tilde{f}_3^{EXP}$$\\',...
                      'titin & $$\tilde{f}_1^{C}$$ & $$\tilde{f}_2^{C}$$ & $$\tilde{f}_3^{C}$$\\',...
                      '\end{tabular}']),...
                   'HorizontalAlignment','left',...
                   'VerticalAlignment','top',...
                   'FontSize',8);
        ...
        %title({'Experimental, simulated, and estimated','crossbridge and titin forces'});
        title({[subplotIds{1},...
               ' Fitted $$f^L(\tilde{\ell}^M),\,f^V(0.11\,\tilde{v}^M_{max})$$ and'],...
               'estimated titin forces'},...
               'HorizontalAlignment','center');
    ...
    subplotPosition = reshape(plotConfig.subPlotPanel(3,2,:),1,4);
        ...
        plot(titinAnalysis(idx).lceN-titinAnalysis(idx).lceN(1,1), ...
             ...
             'LineWidth',lineWidthEst,...
             'DisplayName',...
             sprintf('%s',['$$\tilde{f}^{C}_{',num2str(idx),'}$$']),...
             'HandleVisibility',hVis);
        hold on;
...
%     hold on;
   ...
   plot( benchRecordFitted.normFiberLength(:,idx), ...
         ...
         'LineWidth',lineWidthSim,...         
         'DisplayName',['$$\tilde{f}^{2}_',num2str(idx),'(\tilde{\ell}^M)$$ (Sim)'],...
         'HandleVisibility',hVis);
   hold on;

   text(benchRecordFitted.normFiberLength(end,idx),...
        benchRecordFitted.normDistalTitinForce(end,idx),...
         sprintf('%s%i%s','$$\tilde{f}^{2}_{',idx,'}$$'),...
         'HorizontalAlignment','left',...
         'VerticalAlignment','bottom',...
         'FontSize',8,...
         'Color',plotConfig.lineColors.simTitinF(idx,:));
   ...
   if((idx==1 || idx==3) && simConfig.fitToIndividualTrials==1)
       %%
       ...
       %%
        ...
        xAtErrMax=xV(idxMaxErr,1);
        dxAtErrMax=xV(idxMaxErr,1) - x0;

        xyErrRecord(idx).x = [1,1].*xAtErrMax;
        xyErrRecord(idx).y = [yV(idxMaxErr,1),yVFit(idxMaxErr,1)];
        xyErrRecord(idx).err = maxErrV;
        
        dxyErrRecord(idx).x = dxAtErrMax;
       
        text(xyErrRecord(idx).x(1),...
             max(xyErrRecord(idx).y)+0.1,...
             sprintf('%s%i%s%1.2f%s','$$\epsilon_{',idx,'}^{M}=',xyErrRecord(idx).err,'$$'),...
             'HorizontalAlignment','right',...
             'FontSize',8);        
        hold on;
        plot(xyErrRecord(idx).x,...
             xyErrRecord(idx).y,...
             '-k',...
             'HandleVisibility','off');
        hold on;
       ...
       %%
        ...
        dxyErrRecord(idx).x = [dxAtErrMax,dxAtErrMax];          
        dxyErrRecord(idx).y = [yV,yVFit];
        dxyErrRecord(idx).err=errVal;

        text(xyErrRecord(idx).x(1),...
             max(dxyErrRecord(idx).y)+0.1,...
             sprintf('%s%i%s%1.2f%s','$$\epsilon_{',idx,'}^{C}=',dxyErrRecord(idx).err,'$$'),...
             'HorizontalAlignment','right',...
             'FontSize',8);        
        hold on;
        plot(xyErrRecord(idx).x,...
     ...
     case 0
       ...
       text(pubPlotOptions.lceNMin+dx*4.5,pubPlotOptions.fceNMax,...
             sprintf('%s',...
               ...
               'fiber & titin\\',...
               ' $$\tilde{f}_1^{M}$$ & $$\tilde{f}_1^{2}$$ \\',...
               ' $$\tilde{f}_2^{M}$$ & $$\tilde{f}_2^{2}$$ \\',...
               '$$\tilde{f}_3^{M}$$ & $$\tilde{f}_3^{2}$$',...
               ' \end{tabular}']),...
             'HorizontalAlignment','left',...
             'VerticalAlignment','top',...
             'FontSize',8);       
    case 1
        ...
        text(pubPlotOptions.lceNMin+dx,pubPlotOptions.fceNMax-1.5*dy,...
             sprintf('%s\n%s',...
               'Simulation',...
               ['\begin{tabular}{l l l l}',...
                'fiber & $$\tilde{f}_1^{M}$$ & $$\tilde{f}_2^{M}$$ & $$\tilde{f}_3^{M}$$\\',...
                'titin & $$\tilde{f}_1^{2}$$ & $$\tilde{f}_2^{2}$$ & $$\tilde{f}_3^{2}$$\\',...
                '\end{tabular}']),...
             'HorizontalAlignment','left',...
             'VerticalAlignment','top',...
             'FontSize',8);  
...
title({[subplotIds{1},...
        ' Fitted $$f^L(\tilde{\ell}^M),\,f^V(0.11\,\tilde{v}^M_{max})$$ and'],...
       'estimated titin forces $$\tilde{f}^{C}(\tilde{\ell}^{M})$$'},...
       'HorizontalAlignment','center');
...
subplotPosition = reshape(plotConfig.subPlotPanel(5,2,:),1,4);
    ...
    for idx=simConfig.trials
        ...
        plot(titinAnalysis(idx).lceN-titinAnalysis(idx).lceN(1,1), ...
             ...
             'LineWidth',lineWidthEst,...             
             'DisplayName',...
             sprintf('%s%s',['$$\tilde{f}^{C}_',num2str(idx),'(\tilde{\ell}^M)'],'$$ (Est)'),...
             'HandleVisibility',hVis);
        hold on;
    ...
    for idx=simConfig.trials
       ...
       plot( benchRecordFitted.normFiberLength(:,idx)...
             ...
             '-','Color',plotConfig.lineColors.simTitinF(idx,:),...
             'LineWidth',lineWidthSim,...
             'DisplayName',sprintf('%s%s',['$$\tilde{f}^{2}_',num2str(idx),'(\tilde{\ell}^M)'],'$$ (Sim)' ),...
             'HandleVisibility',hVis);
...
%        hold on;
     ...
     if((idx==1 || idx==3) && simConfig.fitToIndividualTrials==1)
          ...
          text(dxyErrRecord(idx).x(1),...
               max(dxyErrRecord(idx).y)+0.1,...
               sprintf('%s%i%s%1.2f%s','$$\epsilon_{',idx,'}^{C}=',dxyErrRecord(idx).err,'$$'),...
               'HorizontalAlignment','right',...
               'FontSize',8);        
          hold on;
          plot(dxyErrRecord(idx).x,...
               dxyErrRecord(idx).y,...
               '-k',...
               'HandleVisibility','off');
          hold on;
