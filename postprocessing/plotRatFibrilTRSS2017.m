...
idxFieldsTRSS2017 = {'lN070','lN085','lN145'};
...
for idxTrial = simConfig.trials
    seriesName = idxFieldsTRSS2017{idxTrial};
...
subplotPosition = reshape(plotConfig.subPlotPanel(1,2,:),1,4);
    ...
    for idx=simConfig.trials
        ...
        seriesName = idxFieldsTRSS2017{idx};
        ...
        stdAreaColor = plotConfig.lineColors.exp(idx,:).*0.5 + [1,1,1].*0.5;
