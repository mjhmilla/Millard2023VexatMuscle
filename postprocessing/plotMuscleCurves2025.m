...
if(muscleModel.sarcomere.titinModelType==1)
  ...
  curveSampleFPEHuman = calcBezierYFcnXCurveSampleVector(...
                humanSoleusMuscle.curves.('fiberForceLengthCurve'), ...
                200,fpeDomain);
...
[ curveSampleECMHalfHuman,...
  ...
  sampleTitinCurves20250612(curveSampleFPEHuman.x.*0.5,...
                    humanSoleusMuscle);   
  ...
  lengthCEHuman     = curveSampleFPEHuman.x.*0.5;    
...
%   hold on;  
  ...
  colorHumanTitin = [1,0,0];
  plot( (lengthCEHuman.*2).*loptHuman,...
        (lengthZ2PevkHuman).*loptHuman,...
        '-','Color',colorHumanTitin,...
        'LineWidth',plotProps(idx).lineWidth,...
        'DisplayName','Human Mdl: ZL to IgD/PEVK',...
        'HandleVisibility',hVis);
  ...
  plot( (lengthCEHuman.*2).*loptHuman,...
        ...
        '-','Color',colorHumanTitin,...
        'LineWidth',plotProps(idx).lineWidth,...
        'DisplayName','Human Mdl: ZL to PEVK/IgD',...
        'HandleVisibility',hVis);
  ...
  plot( (lengthCEHuman.*2).*loptHuman,...
        ...
        '--','Color',colorHumanTitin,...
        'LineWidth',plotProps(idx).lineWidth,...
        'DisplayName','Human Mdl: ZL to IgD/Myosin',...
        'HandleVisibility',hVis);
  %
  % Plot the candidate model
  %

  lopt = muscleModel.sarcomere.optimalSarcomereLength;
  
  colorModelTitin = [0,0,1];
  plot( (lengthCE.*2).*lopt,...
        (lengthZ2Pevk).*lopt,...
        '-','Color',colorModelTitin,...
        'LineWidth',plotProps(idx).lineWidth,...
