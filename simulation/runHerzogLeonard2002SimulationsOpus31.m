...
%             end       
          ...
          activationTitinActinFcn = @(argU,argA)calcFirstOrderActivationDerivative(...
                            argU,argA, sarcomereProperties.activationTimeConstant,...
                                      sarcomereProperties.deactivationTimeConstant*100,0);
          ...
          %%
            ...
            benchConfig.activationTitinActinFcn = activationTitinActinFcn; 
            ...
            calcMillard2019MuscleInfoOpus31Fcn = ...
                 @(activationState1,activationState2, pathState3,mclState4) ...
