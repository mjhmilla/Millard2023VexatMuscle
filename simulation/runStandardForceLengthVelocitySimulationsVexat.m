...
function [success] = runStandardForceLengthVelocitySimulationsVexat(...
...
if(flag_activeForceLengthSimulations==1)
  ...
  save([outputFolder,'activeForceLengthVexat_',nameModification,outputFileEndingVexat,'.mat'],...
      'benchRecord',...
      'flag_useElasticTendon',...
      'musculotendonProperties',...
      'sarcomereProperties',...
...
if(flag_passiveForceLengthSimulations==1)
  ...
  save([outputFolder,'passiveForceLengthVexat_',...
        nameModification,outputFileEndingVexat,'.mat'],...
      'benchRecord',...
      'flag_useElasticTendon',...
      'musculotendonProperties',...
      'sarcomereProperties',...
...
if(flag_forceVelocitySimulations==1)
  ...
  save([outputFolder,'forceVelocityVexat_',nameModification,outputFileEndingVexat,'.mat'],...
    'benchRecord',...
    'flag_useElasticTendon',...
    'musculotendonProperties',...
    'sarcomereProperties',...
