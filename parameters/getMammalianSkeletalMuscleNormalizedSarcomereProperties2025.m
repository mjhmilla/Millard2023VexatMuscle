...
function [sarcomereProperties] = ...
          getMammalianSkeletalMuscleNormalizedSarcomereProperties2025(...
                                animalName,...
...
%
if(setT12ToZLineSegmentToZero==1)
    zLineToT12LengthHuman = 0.0; 
    zLineToT12Length      = 0.0; 
end
...
[lineHumanZToPevkP_raw, lineHumanZToPevkD_raw] = ...
...
ls=[2.25;4.75];
plotLineHumanZToPevkP.x = ls;
plotLineHumanZToPevkP.y = [ls,ones(size(ls))]*lineHumanZToPevkP;
plotLineHumanZToPevkD.x = ls;
plotLineHumanZToPevkD.y = [ls,ones(size(ls))]*lineHumanZToPevkD;

plotLineHumanZToPevkP_raw.x = ls;
plotLineHumanZToPevkP_raw.y = [ls,ones(size(ls))]*lineHumanZToPevkP_raw;
plotLineHumanZToPevkD_raw.x = ls;
plotLineHumanZToPevkD_raw.y = [ls,ones(size(ls))]*lineHumanZToPevkD_raw;
...
%
% This function uses an approximation that works as long as reference
% human model and the target animal have the same total number of
% Ig domains. This is usually not exactly true, but not too far off.

[lineZToPevkP_, lineZToPevkD_] = ...
    scaleTitinElongationFunction(...
        ...
        lineHumanZToPevkP, lineHumanZToPevkD);
%
% This function does not use an approximation and will correctly handle
% the case when the total number of Ig domains and PEVK residues differ
%
...
extra.lineHumanZToPevkP = plotLineHumanZToPevkP;
extra.lineHumanZToPevkD = plotLineHumanZToPevkD;
extra.lineHumanZToPevkP_raw = plotLineHumanZToPevkP_raw;
extra.lineHumanZToPevkD_raw = plotLineHumanZToPevkD_raw;


normFiberForceAtPassiveToe =  1;
...
sarcomereProperties = ...
    struct( 'optimalSarcomereLength', optSarcomereLength,...
            ...
            'normFiberForceAtPassiveToe'                    , normFiberForceAtPassiveToe,...
            ...
            'normTitinSegmentForceMinimum'                  , 1e-3,...
