...
fittingFilesActiveForceLength      = ...
    fullfile(projectFolders.experiments_SW1982,...
    'data','StephensonWilliams1982_Fig7_fl.csv'     );

fittingFilesPassiveForceLength      = ...
    fullfile(projectFolders.experiments_SW1982,...
    'data','StephensonWilliams1982_Fig7_fpe.csv'     );


dataSW1982Fig7Fl = loadDigitizedData(fittingFilesActiveForceLength,...
                        'Length (um)','Norm. Force (f/fo)',...
                        {'EDL (low temp)','EDL (norm. temp)',...
                         'SOL (low temp)','SOL (norm. temp)'},);

dataSW1982Fig7Fpe = loadDigitizedData(fittingFilesActiveForceLength,...
                        'Length (um)','Norm. Force (f/fo)',...
                        {'EDL and SOL'});


ratSoleusFibrilActiveForceLengthData  = dataSW1982Fig7Fl;
ratSoleusFibrilPassiveForceLengthData = dataSW1982Fig7Fpe;
