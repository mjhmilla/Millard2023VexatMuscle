...
function [rabbitEDLMusculotendonProperties, ...
...
%
% @param scalePathLength: scales the optimal fiber length
%
...
%     the muscle.
%%
%scalePathLength               = 1.0; %user-settable parameter
...
maximumNormalizedFiberVelocity = 12.3; % in units of norm fiber lengths/second
...
normPlateauOffset = ...
  rabbitEDLSarcomereProperties.normMyosinBareHalfLength;


%Get the default musculotendon properties for the feline soleus
[rabbitEDLMusculotendonProperties,...
 rabbitEDLMusculotendonPropertiesExp ] = ...
...
[rabbitEDLActiveForceLengthData,...
rabbitEDLPassiveForceLengthData] = getRabbitEDLMusculotendonData(...
                              rabbitEDLMusculotendonPropertiesExp,...
                              rabbitEDLMusculotendonProperties,...
                              normPlateauOffset,...
                              useElasticTendonExp,...
