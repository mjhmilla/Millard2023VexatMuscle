...
nameSarcomerePropertiers = ['rat',muscleName];
...
ratSoleusSarcomereProperties.normFiberLengthAtOneNormPassiveForce =...
    normFiberLengthAtOneNormPassiveForce;
ratSoleusSarcomereProperties.normFiberForceAtPassiveToe = ...
  normFiberForceAtPassiveToe;

ratSoleusSarcomereProperties.normLengthTitinActinBondMinimum = ...
    normLengthTitinActinBondMinimum;
...
%
maximumNormalizedFiberVelocity = nan;

switch muscleName
    case 'SOL'
        maximumNormalizedFiberVelocity = 1.02; 
