...
if(fittingConfig.fitFpeQToF==1)
  if(simConfig.fitToIndividualTrials==1)
      tagList = {'<flParam>',  '<flError1>',  '<flError2>',  '<flError3>',...
                 '<fvParam>',  '<fvError1>',  '<fvError2>',  '<fvError3>',...
                 '<QParam1>'   ,'<kToeParam1>','<normLengthToeParam1>','<curvinessParam1>',...
                 '<QParam2>'   ,'<kToeParam2>','<normLengthToeParam2>','<curvinessParam2>',...
                 '<QParam3>'   ,'<kToeParam3>','<normLengthToeParam3>','<curvinessParam3>',...                 
