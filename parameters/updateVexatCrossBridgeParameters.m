...
function [muscleArchitectureUpd,sarcomerePropertiesUpd] = ...
  updateVexatCrossBridgeParameters(nominalForceN,...
...
%       in the 'runPerturbationSimulationsVexat' and 
...
mtInfoBest =calcMillard2023VexatMuscleInfo([0,actBest],...
                                      pathState0,...
                                      muscleState0,...
                                      muscleArchitecture,...
                                      sarcomereProperties,...
...
for i=1:1:10
  ...
  mtInfoL =calcMillard2023VexatMuscleInfo([0,actLeft],...
                                        pathState0,...
                                        muscleState0,...
                                        muscleArchitecture,...
                                        sarcomereProperties,...
...
%                                         modelConfig);                                      
  ...
  modelConfig.initializeState =1; 
  mtInfoR =calcMillard2023VexatMuscleInfo([0,actRight],...
                                        pathState0,...
                                        muscleState0,...
                                        muscleArchitecture,...
                                        sarcomereProperties,...
