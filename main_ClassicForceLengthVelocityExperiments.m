...
if(flag_simulateOpus31Model == 1)
  ...
  normMuscleCurvesOpus31.useCalibratedCurves = 1;
...
if(flag_plotData == 1)
  ...
  dataActiveForceLength31 = ...
    load([structsFolder,'activeForceLengthOpus31_',...
          nameModification,outputFileEndingOpus31_NotCal,'.mat']);

  dataPassiveForceLength31 = ...
    load([structsFolder,'passiveForceLengthOpus31_',...
          nameModification,outputFileEndingOpus31_NotCal,'.mat']);

  dataForceVelocity31 = ...
    load([structsFolder,'forceVelocityOpus31_',...
          nameModification,outputFileEndingOpus31_NotCal,'.mat']);        
