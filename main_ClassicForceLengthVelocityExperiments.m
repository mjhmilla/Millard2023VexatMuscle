...
if(flag_plotData == 1)
  ...
  if(flag_buildCombinedPlot==1)
    ...
    lineColorOpus31Cal  = lineColorOpus31Cal.*0.25+[1,1,1].*0.75;
...
% The calibrated Opus31 results
  for k=1:1:size(dataActiveForceLength31Cal.benchRecord.time,2)  
    ...
    plot( dataActiveForceLength31Cal.benchRecord.normFiberLength(end,k), ...
          ...
          -fpeATOpus31,...
          'o',...
          'Color',lineColorOpus31Cal,'LineWidth',0.5,...
          'MarkerSize',markerSize,...
          'MarkerFaceColor',lineColorOpus31Cal,...
    ...
    if( abs(dataActiveForceLength31Cal.benchRecord.normFiberLength(end,k)-1)<0.025)
      subplot('Position',reshape(subPlotPanel(2,1,:),1,4));
        ...
        plot( dataActiveForceLength31Cal.benchRecord.time(end,k), ...
              dataActiveForceLength31Cal.benchRecord.normFiberForce(end,k),...
              'o','Color',lineColorOpus31Cal,'LineWidth',0.5,...
              'MarkerSize',markerSize,...
              'MarkerFaceColor',lineColorOpus31Cal,...
              'DisplayName',nameOpus31Cal);
        hold on;  
  ...
  if(flag_buildCombinedPlot==2)  
    ...
    %legend boxoff;
    colorHillRT     = lineColorHill.*0.25+[1,1,1].*0.75;
    colorModelRT    = lineColorOpus31.*0.25+[1,1,1].*0.75;
    colorModelRTCal = lineColorOpus31Cal.*0.25+[1,1,1].*0.75;
    ...
    plot(  x0,1.-dy,'o','Color',colorModelRTCal,'MarkerFaceColor',colorModelRTCal,...
          'MarkerSize',4,'LineWidth',0.5);
    hold on;
    text(  x0+dx,1-dy,'Model: RT (Cal)');
    hold on;    

    plot( x0,1-2*dy,'x','Color',colorHillRT,'MarkerFaceColor',colorHillRT,...
          'MarkerSize',4,'LineWidth',0.5);
    hold on;    
    text( x0+dx,1-2*dy,'Hill: RT');
    hold on;
    
    plot( x0,1-3*dy,'o','Color',colorModelET,'MarkerFaceColor',colorModelET,...
          'MarkerSize',2,'LineWidth',0.5);
    hold on;        
    text( x0+dx,1-3*dy,'Model: ET');
    hold on;

    plot( x0,1-4*dy,'o','Color',colorModelETCal,'MarkerFaceColor',colorModelETCal,...
          'MarkerSize',2,'LineWidth',0.5);
    hold on;        
    text( x0+dx,1-4*dy,'Model: ET (Cal)');
    hold on;


    plot( x0,1-5*dy,'x','Color',colorHillET,'MarkerFaceColor',colorHillET,...
          'MarkerSize',2,'LineWidth',0.5);
    hold on;            
    text( x0+dx,1-5*dy,'Hill: ET');
    hold on;
...
colorHillRT     = lineColorHill.*0.25+[1,1,1].*0.75;
    ...
    x0 = -1.1;    
    y0 = 1.45;
    plot(  x0,y0,'o','Color',colorModelRT,'MarkerFaceColor',colorModelRT,...
          'MarkerSize',4,'LineWidth',0.5);
    hold on;
    text(  x0+dx,y0,'Model: RT');
    hold on;

    plot(  x0,y0-dy,'o','Color',colorModelRTCal,'MarkerFaceColor',colorModelRTCal,...
          'MarkerSize',4,'LineWidth',0.5);
    hold on;
    text(  x0+dx,y0-dy,'Model: RT (Cal)');
    hold on;    

    plot( x0,y0-2*dy,'x','Color',colorHillRT,'MarkerFaceColor',colorHillRT,...
          'MarkerSize',4,'LineWidth',0.5);
    hold on;    
    text( x0+dx,y0-2*dy,'Hill: RT');
    hold on;
    
    plot( x0,y0-3*dy,'o','Color',colorModelET,'MarkerFaceColor',colorModelET,...
          'MarkerSize',2,'LineWidth',0.5);
    hold on;        
    text( x0+dx,y0-3*dy,'Model: ET');
    hold on;

    plot( x0,y0-4*dy,'o','Color',colorModelETCal,'MarkerFaceColor',colorModelETCal,...
          'MarkerSize',2,'LineWidth',0.5);
    hold on;        
    text( x0+dx,y0-4*dy,'Model: ET (Cal)');
    hold on;


    plot( x0,y0-5*dy,'x','Color',colorHillET,'MarkerFaceColor',colorHillET,...
          'MarkerSize',2,'LineWidth',0.5);
    hold on;            
