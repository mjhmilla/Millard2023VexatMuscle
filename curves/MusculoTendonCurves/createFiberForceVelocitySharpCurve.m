...
function fiberForceVelocityCurve =  createFiberForceVelocitySharpCurve(...
                                        fvAtHalfVmax,...  
                                        fvAtLowEccVel,...                                        
                                        fvAtMaxEccVel,...
                                        eccCurviness,...
...
cE = eccCurviness;%scaleCurviness(eccCurviness);
...
eccPts1  = ...
    ...
    xIso,     yIso, dydxIso*dydxEcc_div_dydxConc, 0, ...
    xE,       yE,   dydxE, 0, cE);
