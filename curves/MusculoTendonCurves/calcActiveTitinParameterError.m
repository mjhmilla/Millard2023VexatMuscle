...
switch sarcomerePropertiesVexat.titinModelType
    case 0
        ...
        sarcomerePropertiesVexat.normPevkToActinAttachmentPoint = ...
            parameterA;
    ...
    case 1
        ...
        sarcomerePropertiesVexat.extraCellularMatrixPassiveForceFraction = ...
            parameterA;
        sarcomerePropertiesVexat.normActivePevkDamping = ...
            parameterB;
 ...
 normMuscleCurves.forceLengthIgDTitinCurve, ...
    normMuscleCurves.forceLengthIgDTitinInverseCurve] ...
          = createTitinCurves2022( normMuscleCurves.fiberForceLengthCurve,...                                   
                                   ...
                                   flag_computeCurveIntegrals,...
                                   flag_useElasticIgD,...
                                   sarcomerePropertiesVexat.titinModelType,...
                                   flag_useOctave);
...
if(flag_useElasticTendon == 1)
    simFileName = ['benchRecordVexat_','ElasticTendon',outputFileEndingVexat,'.mat'];
else
    simFileName = ['benchRecordVexat_','RigidTendon',outputFileEndingVexat,'.mat'];
end
