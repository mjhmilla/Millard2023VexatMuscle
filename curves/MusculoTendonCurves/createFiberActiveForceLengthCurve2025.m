...
function [activeForceLengthCurve, ...
  ...
  createFiberActiveForceLengthCurve2025(  normMyosinLength, ...
...
c1y = c1y+adjustAscendingLimbNormalizedForce;
...
%                                                p3x, p3y,  p3DyDx, 0, c);
    ...
    xpts = [b0(:,1) b1(:,1) b3(:,1) b4(:,1)];
    ypts = [b0(:,2) b1(:,2) b3(:,2) b4(:,2)];
else
    activeForceLengthCurveAnnotationPoints = struct('x',[],'y',[]);
    activeForceLengthCurveAnnotationPoints.x ...
                        = [c0x;...
