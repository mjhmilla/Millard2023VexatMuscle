...
useWLCTitinModel = setSarcomereProperties.useWLCTitinModel;  

shiftLengthActiveForceLengthCurveDescendingCurve = 0;
if(isfield(setCurveProperties,...
           'shiftLengthActiveForceLengthCurveDescendingCurve'))
    shiftLengthActiveForceLengthCurveDescendingCurve = ...
        setCurveProperties.shiftLengthActiveForceLengthCurveDescendingCurve;
end

useCalibratedCurves         = setCurveProperties.useCalibratedCurves;   
...
[normMuscleCurves.activeForceLengthCurve, ...
  activeForceLengthCurveAnnotationPoints] ...
    = createFiberActiveForceLengthCurve2025(...
          ...
          curvinessActiveForceLength, ...           
          shiftLengthActiveForceLengthCurveDescendingCurve,...
          setCurveProperties.flC.adjustAscendingLimbNormalizedForce,...
          setCurveProperties.flC.useRoundAscendingLimb,...
...
if(~isempty(setForceLengthCurveSettings))
  forceLengthCurveSettings=setForceLengthCurveSettings;
end
%%
%
...
if(useTitinModel2025==0 )
  ...
  normMuscleCurves.useTitinCurves2025=0;  
  ...
  normMuscleCurves.flag_useOctave                     = flag_useOctave                     ;                           
  ...
  if(abs(sarcomereProperties.ZLineToT12NormLengthAtOptimalFiberLength)<1e-6)
