...
expTRSS2017Raw = struct('lN070',[],'lN085',[],'lN145',[],'lN145Long',[]);

%expTRSS2017Raw.keyIndices = ...
%  struct('lN070',[],'lN085',[],'lN145',[],'lN145Long',[]);
expTRSS2017Raw.trials = {'lN070','lN085','lN145'};
expTRSS2017Raw.trialsLong = {'lN145Long'};


for i=1:1:size(expTRSS2017RawFields,1)
  expTRSS2017Raw.(expTRSS2017RawFields{i,2}) = ...
  ...
  expTRSS2017Raw.keyIndices.(expTRSS2017RawFields{i,2})=tmp.keyIndices;
end
expTRSS2017Raw.sampleFrequencyHz = 1000;
