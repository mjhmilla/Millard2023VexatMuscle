...
expTRSS2017Raw.lN070 = readtable(fullfile(projectFolders.experiments_TRSS2017,...
                    'data_TRSS2017_0p70_shortOutput.csv'));  
expTRSS2017Raw.lN085 = ...
  readtable(fullfile(projectFolders.experiments_TRSS2017,...
                    'data_TRSS2017_0p85_shortOutput.csv'));
expTRSS2017Raw.lN145 = ...
  readtable(fullfile(projectFolders.experiments_TRSS2017,...
                    'data_TRSS2017_1p45_shortOutput.csv'));
expTRSS2017Raw.lN145long = ...
  readtable(fullfile(projectFolders.experiments_TRSS2017,...
                    'data_TRSS2017_1p45_longOutput.csv'));
