...
if(flag_fitActiveTitinProperties==0)
    felineSoleusSarcomerePropertiesDefault.normPevkToActinAttachmentPoint ...
        =0.6;
    felineSoleusSarcomerePropertiesDefault.normMaxActiveTitinToActinDamping...
        =6.573486328125000e+01;
end
...
figure(figH.tendonStiffnessCurve);
    ...
    curveSample = calcBezierYFcnXCurvflag_ploteSampleVector(...
