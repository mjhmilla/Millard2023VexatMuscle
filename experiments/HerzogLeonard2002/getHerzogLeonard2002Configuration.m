...
%Passive ramp
%expData(:,colLengthPassive)
rampPassiveSmooth = filtfilt(b,a, expData(:,colLengthPassive));
rampPassiveSmoothVelocity = ...
    calcCentralDifferenceDataSeries(expData(:,1), rampPassiveSmooth);
rampPassiveSmoothAcceleration = filtfilt(b,a, rampPassiveSmoothVelocity);
rampPassiveSmoothAcceleration = ...
    calcCentralDifferenceDataSeries(expLengthData(:,1), rampPassiveSmoothAcceleration);
...
expConfigHerzogLeonard2002.dataRamp = ...
    struct('time',    expLengthData(:,1),...
           ...
           'forceKeyPoints', ...
               [interp1( expLengthData(:,1),expForceData(:,2),  expLengthData(idxRampT0,1)),...
                interp1( expLengthData(:,1),expForceData(:,2),  expLengthData(idxRampT1,1))]);
...
expConfigHerzogLeonard2002.dataStatic = ...
    struct('time',    expForceStaticData(:,1),...
           ...
           'forceKeyPoints',[expForceStaticData(1,2),expForceStaticData(end,2)]);
...
expConfigHerzogLeonard2002.dataPassive = ...
    struct('time',    expData(:,1),...
           ...
           'forceKeyPoints', ...
               [interp1( expData(:,1),expData(:,colForcePassive), expData(idxRampPassiveT0,1)),...
                interp1( expData(:,1),expData(:,colForcePassive), expData(idxRampPassiveT1,1))]);         
