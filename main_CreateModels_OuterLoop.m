...
[ defaultRabbitEDL,...
  ...
  rabbitEDLPassiveForceLengthCurveSettings ] = ...
        createRabbitExtensorDigitorumLongusModel(...
                ...
                smallNumericallyNonZeroNumber,...
                flag_enableNumericallyNonZeroGradients,...
                scaleOptimalFiberLengthRabbitEDL,... 
...
fileRabbitEDL = fullfile(   projectFolders.output_structs_FittedModels,...
                                    'defaultRabbitExtensorDigitorumLongus.mat');
save(fileRabbitEDL,'defaultRabbitEDL');

if(flag_plotAllRabbitEDLCurves==1)
    figRabbitEDLCurves = ...
    plotStructOfBezierSplines( defaultRabbitEDL.curves,...
                                      {'Inverse','use'});  
