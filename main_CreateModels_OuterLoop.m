...
useShorteningLengtheningSlidingTimeConstants=1;
if(useShorteningLengtheningSlidingTimeConstants==1)
    disp(['Adding option to use a lengthening',...
         ' and shortening sliding time constants']);
end
...
if(flag_makeAndSavePubPlots==1)
  filePathAndName = fullfile(plotOutputFolder,'fig_Pub_MuscleCurves.pdf');
