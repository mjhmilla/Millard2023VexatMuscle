...
activationThresholdActivePevkDamping = ...
  sarcomereProperties.activationThresholdActivePevkDamping;
...
modelConstants = struct( ...
    ...
    'activationThresholdActivePevkDamping', activationThresholdActivePevkDamping,...
...
mtInfo.extra = [modelCachedValues.tau,...
                ...
                modelCachedValues.fxHN,...
                modelCachedValues.fEcmHN,...
                modelCachedValues.f1HN,...
                modelCachedValues.f2HN,...
                modelCachedValues.fTN];
