...
%Titin distal force-length curve: PEVK section with slight adjustment to include
...
fvNVelocityScaling =   sarcomereProperties.fiberVelocityRegularization;
...
slidingTimeConstantShortening = sarcomereProperties.slidingTimeConstantShortening;
slidingTimeConstantLengthening = sarcomereProperties.slidingTimeConstantLengthening;
slidingDynamicsFastToSlowCoefficient = ... 
  sarcomereProperties.slidingDynamicsFastToSlowCoefficient;
slidingDynamicsFastToSlowOffsetCoefficient = ...
  sarcomereProperties.slidingDynamicsFastToSlowOffsetCoefficient;

normCrossBridgeCyclingDampingLengthening = sarcomereProperties.normCrossBridgeCyclingDampingLengthening;
normCrossBridgeCyclingDampingShortening = sarcomereProperties.normCrossBridgeCyclingDampingShortening;
...
modelConstants = struct( ...
    ...
    'fvNVelocityScaling'  , fvNVelocityScaling     ,...
    'tauShortening'       , slidingTimeConstantShortening, ...
    'tauLengthening'       , slidingTimeConstantLengthening,...
    'tauSlowToFastCoefficient', slidingDynamicsFastToSlowCoefficient,...
    'tauSlowToFastOffsetCoefficient', slidingDynamicsFastToSlowOffsetCoefficient,...    
